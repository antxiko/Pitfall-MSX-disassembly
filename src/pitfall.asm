...
;   primera CON LOS NIBBLES INTERCAMBIADOS (61->16, 91->19, B1->1B...).
;   Consumidor sin encontrar: ni una instruccion trazada ni un puntero literal
;   en toda la ROM apuntan aqui. Acotada por el inicializador que acaba en
