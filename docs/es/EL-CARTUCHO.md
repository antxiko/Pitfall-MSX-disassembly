...
| 0xE229-0xE243 | las diez cajas de colisión |
| 0xE247 | cuántos objetos vivos hay, y detrás un puntero por objeto |
| 0xE26A-0xE2BE | la tabla de atributos de sprite, que se vuelca entera cada cuadro |
...
juegos de 16 casillas del decorado (0x95FE-0x97FE) y unos cuantos patrones de
sprite sueltos (0x99AF-0x9A6F): 128 y 32 bytes en crudo, sin nada que ahorrar.
...
| 0x9090-0x95FE | los cinco bloques grandes de gráficos comprimidos |
| 0x95FE-0x97FE | los cuatro juegos de 16 casillas del decorado |
| 0x97FE-0x9A6F | los sprites: nueve bloques comprimidos y seis patrones en crudo |
...
| 0xB393-0xB6B1 | los diez sonidos, con sus guiones |
